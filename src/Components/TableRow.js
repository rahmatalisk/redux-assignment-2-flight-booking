...
const TableRow = ({book,index,cancelBooking}) => {
  const {destinationTo,destinationFrom,journeyDate,guests,ticketClass}= book.bookingDetail;
    ...
    return (
        ...
        <td className="px-6 py-4 text-center">
          <div className="flex justify-center gap-4">
            <button className="lws-remove" onClick={()=>cancelBooking(index)}>
              <svg
